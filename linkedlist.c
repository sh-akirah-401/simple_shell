...
/**
 * add_alias_end - Appends a node to the tail of an alias_t linked list.
 * @head: A pointer to the head of the list_t list.
 * @name: name of the new alias added.
 * @value: value of the new alias added.
 * Return: In case of an error, the result is NULL.
